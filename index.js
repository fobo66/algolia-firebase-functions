...
exports.syncAlgoliaWithFirebase = syncAlgoliaWithFirebase;
exports.syncAlgoliaWithFirestore = syncAlgoliaWithFirestore;
/**
...
// any is coming from Realtime Database
// eslint-disable-next-line @typescript-eslint/no-explicit-any
function prepareObjectToExporting(id, data) {
 ...
 */
async function updateExistingOrAddNewFirebaseDatabaseObject(dataSnapshot, client, index) {
 ...
 * @param index - Algolia index name
 */
async function updateExistingOrAddNewFirestoreObject(dataSnapshot, client, index) {
    return client.saveObjects({
        indexName: index,
 ...
 * @param index - Algolia index name
 */
const removeObject = async (id, client, index) => client.deleteObject({
    indexName: index,
    objectID: id,
});
/**
 ...
 */
async function syncAlgoliaWithFirebase(client, index, change) {
 ...
 */
async function syncAlgoliaWithFirestore(client, index, change) {
    if (!change.after.exists) {
